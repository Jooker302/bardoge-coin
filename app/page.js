    ...
    <>
      ...
      <div id="boxes" class="md:mt-10 mt-6 flex justify-center py-8 flex-wrap">
        <div class="w-full md:w-1/4 my-6 md:my-0 bg-white shadow-md rounded-lg md:mx-4">
          ...
          <div class="p-4">
            <h2 class="text-xl font-semibold mb-2 mt-4">Token Supply</h2>
            <p class="text-gray-600">Bardoge has a supply of 500000</p>
          </div>
        </div>
      ...
      <div className="py-10 md:pb-14 flex items-center justify-center">
        <img
          src="/cover.jpeg"
          alt="Pulsating Image"
      ...
      <div className="p-6 flex justify-center flex-wrap">
        <div className="flex justify-center flex-col items-center shadow-md m-2 p-4 md:w-2/5">
        ...
        <div className="flex justify-start flex-col items-center p-4 md:w-2/5 shadow-md m-2">
          <p className="text-3xl font-bold">Coin Launch on </p>
          <p className="p-1">Bardoge is listed on Arbitrum Chain.</p>
          <p>
